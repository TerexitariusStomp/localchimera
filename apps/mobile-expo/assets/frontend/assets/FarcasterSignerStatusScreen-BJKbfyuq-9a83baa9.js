import{aY as a,bN as y,dE as F,cP as T,aU as I,cC as O,aV as d,ee as k}from"./index-ba860db5.js";import{a2 as _,g as n}from"./index-00419ca3.js";import{h as q}from"./CopyToClipboard-DSTf_eKU-e9d249b3.js";import{n as B}from"./OpenLink-DZHy38vr-41c96da5.js";import{C as E}from"./QrCode-BxAVhbx2-ec238651.js";import{n as P}from"./ScreenLayout-Ce16-u0i-552077d3.js";import{l as h}from"./farcaster-DPlSjvF5-dfd791d8.js";import"./browser-e933942f.js";import"./ModalHeader-YbJk-YIQ-1ed844bc.js";import"./Screen-CdOj1bUg-dadd3ff4.js";import"./index-Dq_xe9dz-184c2771.js";let S="#8a63d2";const A=({appName:p,loading:m,success:i,errorMessage:e,connectUri:r,onBack:s,onClose:c,onOpenFarcaster:o})=>a.jsx(P,y||m?F?{title:e?e.message:"Add a signer to Farcaster",subtitle:e?e.detail:`This will allow ${p} to add casts, likes, follows, and more on your behalf.`,icon:h,iconVariant:"loading",iconLoadingStatus:{success:i,fail:!!e},primaryCta:r&&o?{label:"Open Farcaster app",onClick:o}:void 0,onBack:s,onClose:c,watermark:!0}:{title:e?e.message:"Requesting signer from Farcaster",subtitle:e?e.detail:"This should only take a moment",icon:h,iconVariant:"loading",iconLoadingStatus:{success:i,fail:!!e},onBack:s,onClose:c,watermark:!0,children:r&&y&&a.jsx(M,{children:a.jsx(B,{text:"Take me to Farcaster",url:r,color:S})})}:{title:"Add a signer to Farcaster",subtitle:`This will allow ${p} to add casts, likes, follows, and more on your behalf.`,onBack:s,onClose:c,watermark:!0,children:a.jsxs(N,{children:[a.jsx(R,{children:r?a.jsx(E,{url:r,size:275,squareLogoElement:h}):a.jsx(U,{children:a.jsx(_,{})})}),a.jsxs(V,{children:[a.jsx(L,{children:"Or copy this link and paste it into a phone browser to open the Farcaster app."}),r&&a.jsx(q,{text:r,itemName:"link",color:S})]})]})});let M=n.div`
  margin-top: 24px;
`,N=n.div`
  display: flex;
