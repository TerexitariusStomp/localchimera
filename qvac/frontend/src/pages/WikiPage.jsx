...
import { usePrivySafe } from '../privy-context.jsx';
...
export default function WikiPage({ onBack }) {
  const { authenticated, login, logout, user } = usePrivySafe();
    ...
    <div style={{ ...s.layout, ...(isMobile ? { flexDirection: 'column', height: 'auto', overflow: 'auto' } : {}) }}>
      ...
      <aside style={{
        ...
        <div style={{ padding: '10px 12px', borderTop: '1px solid rgba(255,255,255,0.06)', borderBottom: '1px solid rgba(255,255,255,0.06)', display: 'flex', flexDirection: 'column', gap: 6 }}>
          ...
          <div style={{ display: 'flex', gap: 4 }}>
            <button
              style={{ flex: 1, padding: '5px 0', fontSize: 10, borderRadius: 5, cursor: 'pointer', background: nodeRunning ? '#166534' : '#161410', color: nodeRunning ? '#86efac' : '#7a7468', border: '1px solid rgba(255,255,255,0.07)' }}
              onClick={startNode}
            ...
            <button
              style={{ flex: 1, padding: '5px 0', fontSize: 10, borderRadius: 5, cursor: 'pointer', background: !nodeRunning ? '#450a0a' : '#161410', color: !nodeRunning ? '#fca5a5' : '#7a7468', border: '1px solid rgba(255,255,255,0.07)' }}
              onClick={stopNode}
              disabled={!nodeRunning || !authenticated}
